...
//Families
Route::get('employees/families/{id}','employeesController@createFamily');
Route::post('employees/families/store','employeesController@storeFamily');
Route::get('employees/families/delete/{id}','employeesController@deleteFamily');
//Certificates
Route::get('employees/certificates/{id}','employeesController@createCertificates');
Route::post('employees/certificates/store','employeesController@storeCertificates');
Route::get('employees/certificates/delete/{id}','employeesController@deleteCertificates');
//Schools
Route::get('employees/schools/{id}','employeesController@createSchools');
Route::post('employees/schools/store','employeesController@storeSchools');
Route::get('employees/schools/delete/{id}','employeesController@deleteSchools');
//Branches
Route::get('companies/branches/{id}','companiesController@createBranches');
Route::post('companies/branches/store','companiesController@storeBranches');
Route::get('companies/branches/delete/{id}','companiesController@deleteBranches');